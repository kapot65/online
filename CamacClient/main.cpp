 ...
 *
 * \section Введение
 * Программный комплекс Online предназначен для набора данных на установке Троицк ню масс. Комплекс написан на Qt 5.4 (4.8 для CCPC7_Server) с использованием сторонних библиотек QJson, QCustomPlot и easylogging++. Комплекс состоит из 4 программ:
