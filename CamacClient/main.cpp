 ...
 *         }
 *
 *    Если на неинициализированный блок будет послана команда, то сервер выдаст ошибку:
 *
 *         {
 *           "type": "reply",
 *           "reply_type": "error",
 ...
 *           "block" : "1",
 *           "stage": "check init",
 *           "description": "1 has not inited yet"
 *         }
 *
 *    Здесь:
 *    - "error_code" - Код ошибки. Подробнее о кодах ошибок можно прочитать в описании нумерации \ref errType "ERROR_TYPE"
 *    - "description" - Текстовое описание ошибки.
 *
 *  * <b>Проверка инициализации</b>
 *
 *    Команда:
 *
 *         {
 ...
 *
 *    Здесь:
 *    - "error_code" - Флаг проинициализированности блока. "true" или "1" - в случае, если блок проинициализированн, "0" или "false" в противном случае.
 *
 *  * <b>Запрос напряжения</b>
 *
 *    Команда:
 *
 *         {
 *           "block": "1",
 *           "command_type" : "get_voltage",
 *           "type" : "command"
 *         }
 *
 *    Ответ:
 ...
 *
 *    Здесь:
 *    - "voltage" - Напряжение на блоке в вольтах.
 *
 ...
 *         }
 *
 *  * Во время выполнения операций сервер занят. Если в это время послать ему команду, от ответит сообщением
 *
 *         {
 *           "type": "reply",
 *           "reply_type": "error",
