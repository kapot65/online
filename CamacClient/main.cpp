 ...
 * Необходимые поля для работы HVServer:
 *
 * - Группа Divider1
 *  - COM - Имя Com порта основного блока напряжения.
 *  - NormingCoefficient - Коэффициент делителя для основного блока напряжения.
 * - Группа Divider2
 *  - COM - Имя Com порта блока смещения.
 *  - NormingCoefficient - Коэффициент делителя для блока смещения.
 * - Группа HVController1
 *  - COM - Имя Com порта для вольтметра основного блока напряжения.
 ...
 *  - COM - Имя Com порта для вольтметра блока смещения.
 ...
 *
 * Также, для записи логов нужно создать папку c адресом E:/Logs.
 *
 ...
 * \subsubsection vDesctopPrepaire Настройка удаленных рабочих столов
 ...
 * \image html ccpcDesktop.png "Иконка запуска CCPC_Server"
 * \image html hvDesktop.png "Иконка запуска HV_Server"
 *
 * \subsection Client Управление набором с помощью CamacClient
 * \image html clientDesktopShortcuts.png "Расположение ярлыков на рабочем столе."
