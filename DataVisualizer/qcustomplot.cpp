...
void QCPGraph::setData(const QVector<double> &key, const QVector<int> &value)
{
	mData->clear();
	int n = key.size();
	n = qMin(n, value.size());
...
void QCPGraph::setData(const QVector<int> &key, const QVector<int> &value)
{
	mData->clear();
	int n = key.size();
	n = qMin(n, value.size());
...
void QCPBars::setData(const QVector<double> &key, const QVector<int> &value)
{
	mData->clear();
	int n = key.size();
	n = qMin(n, value.size());
